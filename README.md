...
一款基于 RN 的 Android APP, 应用场景是: 坐车时认认真真在看书, 又要时不时分心去留意当前站点, 真心累.

到这儿帮你解决这个问题, 只需要添加目的地, 设置提醒距离, 到这儿便会在即将到达时提醒你, 再也不用担心坐过站, 何不立即下载体验?
...
##### [1.0.0][1]
  ...
  [6]:http://p6igsihtx.bkt.clouddn.com/almosthere-1.7.1.apk
